...
export default function About() {
  return (
    <section id="about" className="py-20 px-6 md:px-12 max-w-[1300px] mx-auto w-full">
      <h2 className="text-4xl md:text-5xl font-black text-white mb-10 text-center"><span className="text-blue-500">About</span> Me</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="border-l-2 border-blue-900 pl-6 space-y-8">
          <div>
            <h3 className="text-xl font-bold text-white">BSc (Hons) in Information Technology</h3>
            <p className="text-blue-500 font-medium">SLIIT University | 2023 - 2027</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-white">Business Management Diploma</h3>
            <p className="text-blue-500 font-medium">IMBS Green Campus | 2023</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-white">G.C.E. Advanced Level</h3>
            <p className="text-blue-500 font-medium">Henegama Central Collage | 2021</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-white">Diploma in Computer Science</h3>
