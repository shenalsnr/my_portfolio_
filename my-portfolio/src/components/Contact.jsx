...
export default function Contact() {
  return (
    <section id="contact" className="py-20 px-6 md:px-12 max-w-[1300px] mx-auto w-full mb-10">
      <h2 className="text-4xl md:text-5xl font-black text-white mb-12 text-center"><span className="text-blue-500">Contact</span> Me</h2>
        ...
        <div className="space-y-6 w-full">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white text-lg">+94 72 2626441</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white text-lg">shenalsnr@gmail.com</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-blue-900/30 rounded-full flex items-center justify-center text-blue-500 font-bold">📍</div>
            <div>
              ...
              <p className="text-white text-lg">Malabe, Colombo</p>
            </div>
          </div>
        </div>
