...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-20 px-6 md:px-12 max-w-[1300px] mx-auto w-full">
      <h2 className="text-4xl md:text-5xl font-black text-white mb-12 text-center">Technical <span className="text-blue-500">Skills</span></h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {categories.map((cat, idx) => (
          <div key={idx} className="bg-[#1a1a1a] border border-gray-800 p-8 rounded-2xl">
            <h3 className="text-2xl font-bold text-white mb-6 border-b border-gray-700 pb-2">{cat.name}</h3>
